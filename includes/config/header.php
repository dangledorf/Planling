					...
					<nav>
						...
						if(is_logged_in()){ //user logged in
							...
							<ul class="inline">
								...
								<li><a href="register">Register<div class="mini-tag col-bg-blue">Free!</div></a></li>
							</ul>
							...
							<ul class="dropdown">
								...
								<li class="help"><a href="register"><div class="fa fa-user"></div>Register<div class="mini-tag col-bg-blue">Free!</div></a></li>
							</ul>';
						}
						?>
